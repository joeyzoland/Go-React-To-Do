...
func Router() *mux.Router {
  ...
  router.HandleFunc("/api/startTask/{id}/{time}", middleware.StartTask).Methods("PUT", "OPTIONS")
  router.HandleFunc("/api/stopTask/{id}/{progress}/{target}", middleware.StopTask).Methods("PUT", "OPTIONS")
  ...
  router.HandleFunc("/api/resetAllTask",
  middleware.ResetAllTask).Methods("PUT", "OPTIONS")
  return router
}
